            ...
            <Form layout='vertical' className='transaction-form' onFinish={onFinish} initialValues={selectedItemForEdit}>
                ...
                <Form.Item label='Category' name='category' rules={[
                    ...
                    <Select placeholder='Select transaction category'>
                        ...
                        <Select.Option value='Food Products'>Foods</Select.Option>
                        <Select.Option value='Machine Equipment'>Machine Equipment</Select.Option>
                        <Select.Option value='Vehicle Service'>Vehicle Service</Select.Option>
                        ...
                        <Select.Option value='Sells'>Other Expense</Select.Option>
                    </Select>
                </Form.Item>
